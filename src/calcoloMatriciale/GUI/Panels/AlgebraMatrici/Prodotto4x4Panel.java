...
public class Prodotto4x4Panel extends JPanel {
    ...
    public Prodotto4x4Panel(MainFrame pMainFrame) {
        ...
        this.buttonProdotto.setBounds(333, 420, 145, 60);
    ...
    protected void paintComponent(Graphics g) {
        ...
        //parentesi dx
        g.fillRect(394, 70, 5, 240);  //verticale
        ...
        //parentesi sx
        g.setColor(Color.BLACK);
        g.fillRect(401, 70, 5, 240);  //verticale
        //g.fillRect(401, 30, 20, 5);
        //g.fillRect(401, 265, 20, 5);

        //parentesi dx
        g.fillRect(776, 70, 5, 240);  //verticale
        ...
        if (attivaProdotto == true) {
            for (int i = 0; i < 4; i++) {
                for (int j = 0; j < 4; j++) {
                    ...
                    g.drawString("" + matrRisult[i][j], 880 + (spX * i), 150 + (spY * j));
                }
            }
            g.setColor(Color.BLACK);
