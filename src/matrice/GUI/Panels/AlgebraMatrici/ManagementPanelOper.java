...
public class ManagementPanelOper extends JPanel {
    ...
    public ManagementPanelOper(MainFrame pMainFrame) {
        ...
        this.sommaDiff3x3.setBounds(580, 60, WIDTH_PULSANTE, HEIGHT_PULSANTE);
        this.sommaDiff3x3.addMouseListener(listner);
        this.sommaDiff3x3.setForeground(Color.WHITE);
        this.sommaDiff3x3.setBackground(new Color(239, 83, 80));
        this.add(this.sommaDiff3x3);

        this.sommaDiff4x4 = new JButton("MATRICE 4x4");
        this.sommaDiff4x4.setBounds(600 + WIDTH_PULSANTE, 60, WIDTH_PULSANTE, HEIGHT_PULSANTE);
        this.sommaDiff4x4.addMouseListener(listner);
        this.sommaDiff4x4.setForeground(Color.WHITE);
        this.sommaDiff4x4.setBackground(new Color(239, 83, 80));
        ...
        this.prodotto3x3.setBackground(new Color(239, 83, 80));
        ...
        this.prodotto4x4.setBackground(new Color(239, 83, 80));
        ...
        this.inversa2x2.setBackground(new Color(239, 83, 80));
        ...
        this.inversa3x3.setBackground(new Color(239, 83, 80));
        this.add(this.inversa3x3);

        this.indietro = new JButton("INDIETRO");
        this.indietro.setBounds((MainFrame.LARGHEZZA - WIDTH_PULSANTE) / 2, 550, WIDTH_PULSANTE, HEIGHT_PULSANTE);
